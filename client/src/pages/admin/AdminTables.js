...
export default function AdminTables() {
  ...
  const fieldSx = {
    ...
    "& .MuiOutlinedInput-root": {
      ...
      "&:hover fieldset": { borderColor: "rgba(200,169,110,0.3)" },
              ...
              <Grid item xs={6} sm={4} md={3} lg={2} key={table._id}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <TableRestaurant
                        sx={{ fontSize: 36, color: cfg.color, mb: 0.5 }}
                      />
                      <Typography
                        variant="h5"
                        fontWeight={700}
      ...
      {tables.length === 0 && !loading && (
        <Box textAlign="center" py={8}>
          ...
          <Typography sx={{ color: "#555", mb: 2 }}>
            No tables yet. Create some to generate QR codes.
          </Typography>
          <Button
            onClick={() => setBulkOpen(true)}
            variant="contained"
      ...
      >
        ...
        <DialogContent sx={{ textAlign: "center" }}>
          ...
          <Typography variant="body2" sx={{ color: "#9E9E9E", mb: 1 }}>
            Scan to order from Table {qrPreview?.tableNumber}
          </Typography>
          <Typography
            variant="caption"
            sx={{ color: "#555", wordBreak: "break-all", display: "block" }}
          >
            {qrPreview?.qrCode}
          </Typography>
        </DialogContent>
        <DialogActions sx={{ px: 3, pb: 2.5, justifyContent: "center" }}>
          ...
          <Button onClick={() => setQrPreview(null)} sx={{ color: "#9E9E9E" }}>
            Close
          </Button>
        </DialogActions>
      </Dialog>
      ...
      >
        ...
        <DialogContent sx={{ pt: "8px !important" }}>
          <Typography variant="body2" sx={{ color: "#9E9E9E", mb: 2 }}>
            Creates tables 1 through N with QR codes. Skips existing tables.
          </Typography>
          <TextField
            fullWidth
        ...
        <DialogActions sx={{ px: 3, pb: 2.5 }}>
          <Button onClick={() => setBulkOpen(false)} sx={{ color: "#9E9E9E" }}>
            Cancel
          </Button>
          <Button
